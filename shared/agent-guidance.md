...
Canonical source for cross-tool agent guidance in this dotfiles repo. Both Claude Code (via `@` import in `CLAUDE.md`) and Codex (via symlink in `AGENTS.md`) reference this file.
